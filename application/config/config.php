...
$config['base_domain']   = $_SERVER["HTTP_HOST"].$script_path;
$config['document_path'] = $_SERVER['DOCUMENT_ROOT'] . $script_path;
$config['assets_url']    = $config['base_url'].'assets/';
$config['local']         = in_array($config['domain'], array('localhost', '127.0.0.1'));
...
$config['sess_expiration'] = 3000;  //Expira em 50 minutos
